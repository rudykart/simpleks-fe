<template>
   <div class="modal fade" id="createHasilHitung" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <button @click="resetFormHitung()" type="button" class="btn-close" data-bs-target="#createHitung"
            ...
            <div v-if="!loading" class="modal-body">
               ...
               <!-- <div class="mb-2">Tabel Simpleks Awal</div>
               <div v-if="data.simpleks_awal != null" class="border rounded p-3">
                  <table class="table table-sm table-hover mt-1">
                     <thead>
                        <tr>
                           ...
                           <template v-for="(dataKolom, index) in data['simpleks_awal']['namaKolom']">
                              <th scope="col" class="text-center">
                                 {{ dataKolom }}
                              </th>
                           </template>
                     ...
                     <tbody>
                        <tr>
                           ...
                           <template v-for="(z, index) in data['simpleks_awal']['z']">
                              <td scope="col" class="text-center">
                                 {{ z }}
                              </td>
                           </template>
                        </tr>
                        <template v-for="(namaBaris, index) in data['simpleks_awal']['namaBaris']">
                           <tr>
                              <template v-if="index != 0">
                                 <td scope="col" class="text-center">{{ namaBaris }}</td>
                                 <td scope="col" class="text-center"
                                    v-for="(k, index) in data['simpleks_awal']['k'][index - 1]">
                                    {{ k }}
                                 </td>
                              </template>
                           </tr>
            ...
            <div class="modal-footer">
               <button type="button" @click="resetFormHitung()" class="btn btn-secondary" data-bs-target="#createHitung"
