<template>
   <div class="modal fade" id="editHasilHitung" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               ...
               <button @click="resetFormHitung()" type="button" class="btn-close" data-bs-target="#editHitung"
            ...
            <div class="modal-footer">
               <button type="button" @click="resetFormHitung()" class="btn btn-secondary" data-bs-target="#editHitung"
